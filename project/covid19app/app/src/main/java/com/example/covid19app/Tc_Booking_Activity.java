...
public class Tc_Booking_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tc__booking_);
        patient_Name=(EditText) findViewById(R.id.tc_bk_patient);
        patient_phno=(EditText) findViewById(R.id.tc_bk_phno);
        patient_Address=(EditText) findViewById(R.id.tc_bk_address);
        patient_uid=(EditText) findViewById(R.id.tc_bk_uniqueCode);
        patient_symptoms=(EditText) findViewById(R.id.tc_bk_symptoms);
        patient_problem=(EditText) findViewById(R.id.tc_bk_problem);
        tc_Name=(TextView) findViewById(R.id.tc_bk_textView);
        btn_book=(Button) findViewById(R.id.btnTc_bookNow);
    ...
    private void BookFromTestCenter() {
        ...
        final String p_Hp_Name = "Test Center Name";
        final String p_from = "Test Center";
        ...
        if  (p_name.isEmpty()) {
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(Tc_Booking_Activity.this);
    ...
    public void SeeMoreTc(View view) {
